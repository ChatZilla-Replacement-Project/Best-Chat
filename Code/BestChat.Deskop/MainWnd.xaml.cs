namespace BestChat.Desktop
{
	...
	public partial class MainWnd : System.Windows.Window, System.ComponentModel.INotifyPropertyChanged
	{
		...
		protected override void OnInitialized(System.EventArgs e)
		{
			...
			if(treeLogicalSelector.ItemContainerGenerator.ContainerFromItem(treeLogicalSelector.Items[0])
					is System.Windows.Controls.TreeViewItem tvi)
				tvi.IsSelected = true;
		}
		...
		public System.Windows.GridLength ExtendedToolBarRowTwoHeight
		{
			get
			{
				if(gridExtended == null || chkExtendedToolBarShow == null)
					...
					System.Diagnostics.Debug.WriteLine($"Extended: {gridExtended.IsMouseOver}\tCheckbox: {
						chkExtendedToolBarShow.IsChecked}");

				return gridExtended != null && chkExtendedToolBarShow != null && (gridExtended.IsMouseOver ||
					chkExtendedToolBarShow.IsChecked == true) ? System.Windows.GridLength.Auto : new(0);
			}
		}

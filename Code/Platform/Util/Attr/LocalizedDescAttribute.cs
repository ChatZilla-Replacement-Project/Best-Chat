...
namespace BestChat.Util.Attr
{
	...
	{
		public LocalizedDescAttribute(string strKey, string strDefaultVal, string strExtendedKey, string
			strExtendedDefaultVal, System.Type typeToUseToFindResources)
		{

...
namespace BestChat.Util.Collections
{
		...
		where ElementType : class
	{
		#region Constructors & Destructors
			...
			public HashTable(int iOuterTableSize, int iInnerTableSize)
			{
				items = new System.Collections.Generic.SortedList<Key1, System.Collections.Generic.SortedList<Key2,
		...
		#region Properties
			...
			/// </remarks>
			public ElementType? this[Key1 keyOuter, Key2 keyInner]
			{
				get
				{
		...
		#region Methods
			...
			/// </remarks>
			public bool ContainsKeyCombo(Key1 keyOuter, Key2 keyInner)
			{
				if(items.ContainsKey(keyOuter))
				{
					System.Collections.Generic.SortedList<Key2, ElementType?>? inner = items[keyOuter];
		...
		#region IReadOnlyDictionary
			System.Collections.Generic.IReadOnlyDictionary<Key2, ElementType?>? System.Collections.Generic
				.IReadOnlyDictionary<Key1, System.Collections.Generic.IReadOnlyDictionary<Key2, ElementType?>?>.this[Key1 key]
				=> items[key];

			int System.Collections.Generic.IReadOnlyCollection<System.Collections.Generic.KeyValuePair<Key1, System
				.Collections.Generic.IReadOnlyDictionary<Key2, ElementType?>?>>.Count => items.Count;

			System.Collections.Generic.IEnumerable<Key1> System.Collections.Generic.IReadOnlyDictionary<Key1, System
				.Collections.Generic.IReadOnlyDictionary<Key2, ElementType?>?>.Keys => items.Keys;

			System.Collections.Generic.IEnumerable<System.Collections.Generic.IReadOnlyDictionary<Key2, ElementType?>?>
				System.Collections.Generic.IReadOnlyDictionary<Key1, System.Collections.Generic.IReadOnlyDictionary<Key2,
					ElementType?>?>.Values => items.Values;

			bool System.Collections.Generic.IReadOnlyDictionary<Key1, System.Collections.Generic.IReadOnlyDictionary<Key2,
				ElementType?>?>.ContainsKey(Key1 key) => items.ContainsKey(key);
			...
			#region IEnumerable
				...
				System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<Key1, System.Collections.Generic
					.IReadOnlyDictionary<Key2, ElementType?>?>>
					System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<Key1, System.Collections
					.Generic.IReadOnlyDictionary<Key2, ElementType?>?>>.GetEnumerator() => (System.Collections.Generic
					.IEnumerator<System.Collections.Generic.KeyValuePair<Key1, System.Collections.Generic

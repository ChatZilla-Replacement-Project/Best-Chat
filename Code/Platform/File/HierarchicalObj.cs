...
namespace BestChat.Platform.Data
{
	...
	/// <typeparam name="ChildType">The type of the child entries.  Must be derived from <see cref="HierarchicalObj{TypeOfObj, ChildType}.IChildObj"/>
	///		</typeparam>
		...
		where ChildType : HierarchicalObj<TypeOfObj, ChildType>.IChildObj
	{
		...
		protected HierarchicalObj(TypeOfObj? parent = null)
		{
			this.parent = parent;
		...
		/// </summary>
		~HierarchicalObj() => mapAllInstances.Remove(guid);
		...
		/// </summary>
		private readonly System.Collections.Generic.Dictionary<string, ChildType> mapChildrenByName = new();
		...
		/// </summary>
		public System.Collections.Generic.IReadOnlyDictionary<string, ChildType> ChildrenByName => mapChildrenByName;
		...
		/// </para>
		/// </remarks>
		private static readonly System.Collections.Generic.SortedDictionary<System.Guid, HierarchicalObj<TypeOfObj, ChildType>> mapAllInstances = new
			();
		...
		/// </para>
		/// </remarks>
		public static new System.Collections.Generic.IReadOnlyDictionary<System.Guid, HierarchicalObj<TypeOfObj, ChildType>> AllInstancesByGUID => mapAllInstances;

		/// <summary>
		/// Returns <see langword="true"/> if the <see cref="Obj{TypeOfObj}.IsDirty"/> returns <see langword="true"/> or any child is dirty.
		/// </summary>
		public override bool IsDirty => base.IsDirty || mapChildrenByName.Values.Any((ChildType curChild) => curChild.IsDirty);
		...
		protected void NewChild(ChildType childNew) => mapChildrenByName[childNew.Name] = childNew;

		/// <summary>
		/// Called by derived classes when a child was removed.
		/// </summary>
		/// <param name="childRemoved"></param>
		protected void ChildRemoved(ChildType childRemoved) => mapChildrenByName.Remove(childRemoved.Name);
	}
}
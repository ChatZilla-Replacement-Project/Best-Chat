...
namespace BestChat.Platform.Data
{
	...
	public abstract class ObjBase : System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// </summary>
		protected ObjBase() => mapAllInstances[guid] = this;

		/// <summary>
		/// Removes this instance from the list of all instances.
		/// </summary>
		~ObjBase() => mapAllInstances.Remove(guid);
		...
		/// </summary>
		private static readonly System.Collections.Generic.SortedDictionary<System.Guid, ObjBase> mapAllInstances = new();
		...
		/// </summary>
		public static System.Collections.Generic.IReadOnlyDictionary<System.Guid, ObjBase> AllInstancesByGUID => mapAllInstances;
		...
		public static implicit operator System.Guid(ObjBase obj) => obj.guid;
		...
		public static explicit operator ObjBase?(System.Guid guidToLookup) => mapAllInstances.ContainsKey(guidToLookup) ? mapAllInstances[guidToLookup] : null;
		...
		where TypeOfObj : Obj<TypeOfObj>
	{
		...
		#region Delegates
			...
			public delegate void DFieldChanged<FieldType>(TypeOfObj objSender, FieldType oldVal, FieldType newVal);
			...
			public delegate void DBoolFieldChanged(TypeOfObj objSender, bool bNewVal);
			...
			public delegate void DCollectionFieldChanged<CollectionType>(TypeOfObj objSender, CollectionType
			...
			public delegate void OnNewInstanceCreated(TypeOfObj objNewInstance);
		#endregion
		...
		#region Members
			...
			/// </summary>
			private static readonly System.Collections.Generic.SortedDictionary<System.Guid, Obj<TypeOfObj>> mapAllInstances = new();
		#endregion
		...
		#region Methods
			...
			/// <summary>
			/// Clears the <see cref="bIsDirty"/> flag.  <see cref="IsDirty"/> will now return <see langword="false"/>.  <see cref="evtDirtyChanged"/> will be fired.
			/// </summary>
			...
			/// </summary>
			protected void ActAsThoughDirty() => evtDirtyChanged?.Invoke((TypeOfObj)this, bIsDirty);
		#endregion
		...
		#region Operators
			...
			public static explicit operator Obj<TypeOfObj>?(System.Guid guidToLookup) => mapAllInstances.ContainsKey(guidToLookup) ? mapAllInstances[guidToLookup] :
				null;
		#endregion

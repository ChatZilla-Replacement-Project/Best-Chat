...
namespace BestChat.IRC.Data
{
	...
	public class BoolModeState : IModeState<BoolModeStates>
	{
		#region Constructors & Deconstructors
			private BoolModeState(in BoolModeStates stateInternal, in string strTextualDescOfState, in char?
				chCharToDescState)
			{
		...
		#region Members
			...
			private static readonly System.Collections.Generic.SortedDictionary<BoolModeStates, BoolModeState>
				mapEnumToInstance = new()
			{
		...
		#region Properties
			public BoolModeStates State => stateInternal;

			public string TextualDescOfState => strTextualDescOfState;
	...
	{
		#region Constructors & Deconstructors
			private ThreeWayModeState(in ThreeWayModeStates stateInternal, in string strTextualDescOfState, in
				char? chCharToDescState)
			{
				this.stateInternal = stateInternal;
				this.strTextualDescOfState = strTextualDescOfState;
				this.chCharToDescState = chCharToDescState;
		...
		#region Members
			...
			private static readonly System.Collections.Generic.SortedDictionary<ThreeWayModeStates,
				ThreeWayModeState> mapEnumToInstance = new()
				{
		...
		#region Properties
			public ThreeWayModeStates State => stateInternal;
	...
	public interface IReadOnlyMode<ModeStateType, ModeStateTypeInternal> : System.ComponentModel
		...
		where ModeStateTypeInternal : struct, System.Enum
	{
		...
		#region Delegates
			public delegate void DStateChanged(Mode<ModeStateType, ModeStateTypeInternal> modeSender,
				ModeStateType stateOld, ModeStateType stateNew);
		#endregion
		...
		#region Helper Types
				...
				ModeStateTypeInternal>.IReadOnlyParam
			{
				...
				#region Delegates
					public delegate void DValChanged(Param mpSender, object? objOldVal, object? objNewVal);
				#endregion
				...
				#region Properties
					...
					IReadOnlyMode<ModeStateType, ModeStateTypeInternal> IReadOnlyMode<ModeStateType,
						ModeStateTypeInternal>.IReadOnlyParam.Owner => modeOwner;
				#endregion

				#region Methods
					private void FirePropChanged(in string strPropName) => PropertyChanged?.Invoke(this, new
						(strPropName));
		...
		#region Members
			...
			private readonly System.Collections.Generic.SortedDictionary<string, Param> mapParamsByName = new
				();
		#endregion
		...
		#region Properties
			...
			System.Collections.Generic.IReadOnlyDictionary<string, IReadOnlyMode<ModeStateType,
		...
		#region Methods
						...
						switch(chCurFmt)
						{
							case chEsc:
								switch(fmtParseState)
								{
									...
									case FmtParseStates.expectingFieldName:
										throw new System.InvalidProgramException("Found invalid escape sequence in " +
											$"mode format string “{cmdUs.FmtAsSentToNetwork}”: The escape character was followed"
											+ $" by {chCurFmt}, but can only be followed by another escape character, {chEsc}, "
											+ $"or the field start character: {chFieldStart}.");

									default:
										throw new Util.Exceptions.UnknownOrInvalidEnum<FmtParseStates>(fmtParseState,
											"While parsing a format string for modes.");
								}
							...
							case chFieldStart:
								switch(fmtParseState)
								{
									...
									case FmtParseStates.fieldName:
									case FmtParseStates.expectingFieldName:
										throw new System.InvalidProgramException($"The field start character, {
											chFieldStart}, isn't allowed inside a field but was found there.");
							...
							case chFieldEnd:
								switch(fmtParseState)
								{
									...
									case FmtParseStates.expectingFieldName:
										throw new System.InvalidProgramException("The format string for a mode " +
											"specified an empty field name.");
			...
			public override string? ToString() => state.CharToDescState == null ? "" : $"{state.CharToDescState
				}{mdUs.ModeChar} {ApplyFmt()}";
		#endregion

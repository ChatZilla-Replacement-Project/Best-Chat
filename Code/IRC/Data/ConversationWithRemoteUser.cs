...
namespace BestChat.IRC.Data
{
	...
	public class ConversationWithRemoteUser : AbstractConversation, Platform.TreeData.VisualTreeData
		.IItemInfo
	{
				...
				Resources.strRemoteUserDescForTree.Fmt(ru.CurNick, anetOwner.Name))
			{
				...
				this.ru = ru;
					...
					System.Text.Json.JsonDocument doc = System.Text.Json.JsonDocument.Parse(client
						.GetStreamAsync(ru.CurNick switch
						{
							"Peter" => "https://github.com/ChatZilla-Replacement-Project/JSON-Data/blob/main/" +
								"Sample%20Data/Sample%20conversation%20with%20Micheal%20log.json",
							"Micheal" => "https://github.com/ChatZilla-Replacement-Project/JSON-Data/blob/main/" +
								"Sample%20Data/Sample%20conversation%20with%20Peter%20log.json",

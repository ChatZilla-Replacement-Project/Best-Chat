// Ignore Spelling: Ctrls Serv Sel evt

namespace BestChat.IRC.General.Ctrls
{
	public class ChanServOptComboBox : System.Windows.Controls.ComboBox
	{
		#region Constructors & Deconstructors
			public ChanServOptComboBox()
			{
			}
		#endregion
		...
		#region Constants
			#region Dependency Properties
				public static readonly System.Windows.DependencyProperty SelValProperty = System.Windows
					.DependencyProperty.Register(nameof(SelVal), typeof(Data.Defs.ChanServOpts?),
					typeof(ChanServOptComboBox));
			#endregion
			...
			#region Routed Events
				public static readonly System.Windows.RoutedEvent evtSelValChangedEvent = System.Windows
					...
					.Bubble, typeof(System.Windows.RoutedEventHandler), typeof(ChanServOptComboBox));
			#endregion
		#endregion
		...
		#region Properties
			...
			public Data.Defs.ChanServOpts? SelVal
			{
				get => SelectedIndex == -1 || Items.Count == 0 ? default : (Data.Defs.ChanServOpts)((System
		...
		#region Methods
			private static void GetEnumDesc(object objEnumVal, out string strDesc, out string strExtendedDesc)
			{
				...
				System.Reflection.FieldInfo? fieldInfo = objEnumVal.GetType().GetField(strEnumValAsStr) ?? throw
					new System.InvalidProgramException($"Can't find field on instance of type {typeof(Data.Defs.ChanServOpts).FullName} for {strEnumValAsStr}");
			...
			protected override void OnInitialized(System.EventArgs e)
			{
				...
				AddItem(Ctrls.Resources.strChanServOptNull, Ctrls.Resources.strChanServOptNullTooltip, null);
				foreach(object objCurChanServOptVal in System.Enum.GetValues(typeof(Data.Defs.ChanServOpts)))
				{
					GetEnumDesc(objCurChanServOptVal, out string strText, out string strToolTipText);

					AddItem(strText, strToolTipText, objCurChanServOptVal as Data.Defs.ChanServOpts?);
				}
			}

			private void AddItem(string strText, string strToolTipText, Data.Defs.ChanServOpts? val)
			{

...
namespace BestChat.ProtocolMgr.GUI
{
	public sealed class ProtocolGuiMgr : ProtocolMgr
	{
		...
		#region Helper Types
			...
			{
				public Platform.Prefs.Ctrls.VisualPrefsTabCtrl? MakePrefsCtrl(Platform.Prefs.Data
					.AbstractChildMgr cmgrThatWeNeedCtrlFor);

				public BestChat.GUI.Ctrls.VisualConversationTabCtrl MakeConversationCtrl(Platform
